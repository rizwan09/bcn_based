...
def get_args():
    ...
    parser.add_argument('--data', type=str, default='../IMDB/aclImdb/',
                        help='location of the data corpus')
    parser.add_argument('--task', type=str, default='IMDB',
                        help='name of the task [any one of IMDB, snli, multinli, allnli, quora]')
    ...
    parser.add_argument("--num_units", type=int, default=4,
                        help="number of  units per fc layer")
    ...
    parser.add_argument('--save_model', type=str, default='../bcn_output/',
                        help='file name to save the best model as')
    parser.add_argument('--word_vectors_file', type=str, default='glove.6B.300d.txt',
                        help='GloVe word embedding file name')
    parser.add_argument('--word_vectors_directory', type=str, default='../src/glove/',
